...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.prod.ehelply.com';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/1.1.114/PHP';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: 1.1.114' . PHP_EOL;
        $report .= '    SDK Package Version: 1.1.114' . PHP_EOL;
