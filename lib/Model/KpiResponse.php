 ...
 */
class KpiResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KpiResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['kpis'] = $data['kpis'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['kpis'] === null) {
            $invalidProperties[] = "'kpis' can't be null";
        }
