...
/**
 * ProjectsProjectUsageDB Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProjectsProjectUsageDB implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectsProjectUsageDB';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['estimated_cost'] = $data['estimated_cost'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['usage_key'] === null) {
            $invalidProperties[] = "'usage_key' can't be null";
        }
     ...
     * Sets estimated_cost
     *
     * @param int $estimated_cost estimated_cost
     *
     * @return self
     */
