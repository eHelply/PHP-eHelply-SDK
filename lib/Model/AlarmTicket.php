 ...
 */
class AlarmTicket implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlarmTicket';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ticket_uuid'] === null) {
            $invalidProperties[] = "'ticket_uuid' can't be null";
        }
     ...
     * Sets ticket_uuid
     *
     * @param string $ticket_uuid ticket_uuid
     *
     * @return self
     */
