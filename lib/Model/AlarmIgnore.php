 ...
 */
class AlarmIgnore implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlarmIgnore';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ignorer_uuid'] === null) {
            $invalidProperties[] = "'ignorer_uuid' can't be null";
        }
     ...
     * Sets ignorer_uuid
     *
     * @param string $ignorer_uuid ignorer_uuid
     *
     * @return self
     */
