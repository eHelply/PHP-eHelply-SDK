 ...
 */
class AlarmAssign implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlarmAssign';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['assignee_uuid'] === null) {
            $invalidProperties[] = "'assignee_uuid' can't be null";
        }
     ...
     * Sets assignee_uuid
     *
     * @param string $assignee_uuid assignee_uuid
     *
     * @return self
     */
