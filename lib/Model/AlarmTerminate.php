...
/**
 * AlarmTerminate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AlarmTerminate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlarmTerminate';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['terminater_uuid'] === null) {
            $invalidProperties[] = "'terminater_uuid' can't be null";
        }
     ...
     *
     * @param string $terminater_uuid terminater_uuid
     *
     * @return self
     */
