...
/**
 * AlarmAcknowledge Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AlarmAcknowledge implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlarmAcknowledge';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['acknowledger_uuid'] === null) {
            $invalidProperties[] = "'acknowledger_uuid' can't be null";
        }
     ...
     *
     * @param string $acknowledger_uuid acknowledger_uuid
     *
     * @return self
     */
